#Script to build .NetCore application, generate a version number, build 
#docker file, tag it with version number, push it to remote docker hub and
#deploy it on LOCAL k8s cluster
